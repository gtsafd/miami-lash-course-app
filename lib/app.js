...
async function handleApi(req, res) {
  try {
    ...
    if (req.method === "POST" && pathname === "/api/session") return startSession(req, res);
    if (req.method === "GET" && pathname === "/api/me") return me(req, res);
    if (req.method === "POST" && pathname === "/api/bonus") return claimBonus(req, res);
    if (req.method === "GET" && pathname === "/api/leaderboard") return leaderboard(req, res);

    if (req.method === "POST" && pathname === "/api/play/coinflip") return playCoinflip(req, res);
    if (req.method === "POST" && pathname === "/api/play/dice") return playDice(req, res);
    if (req.method === "POST" && pathname === "/api/play/slots") return playSlots(req, res);
    if (req.method === "POST" && pathname === "/api/play/roulette") return playRoulette(req, res);

    if (req.method === "POST" && pathname === "/api/blackjack/deal") return blackjackDeal(req, res);
    if (req.method === "POST" && pathname === "/api/blackjack/hit") return blackjackHit(req, res);
    if (req.method === "POST" && pathname === "/api/blackjack/stand") return blackjackStand(req, res);
    if (req.method === "POST" && pathname === "/api/blackjack/double") return blackjackDouble(req, res);
