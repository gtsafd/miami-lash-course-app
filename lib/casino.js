...
const SLOT_V2_SYMBOLS = [
  { id: "grape", icon: "🍇", name: "Grapes", type: "normal", weight: 24, payout: [0, 0, 3, 10, 34, 105] },
  { id: "watermelon", icon: "🍉", name: "Watermelon", type: "normal", weight: 22, payout: [0, 0, 4, 12, 40, 125] },
  { id: "apple", icon: "🍎", name: "Apple", type: "normal", weight: 20, payout: [0, 0, 5, 15, 50, 150] },
  { id: "lemon", icon: "🍋", name: "Lemon", type: "normal", weight: 18, payout: [0, 0, 6, 18, 60, 180] },
  { id: "cherry", icon: "🍒", name: "Cherry", type: "normal", weight: 17, payout: [0, 0, 7, 21, 70, 210] },
  { id: "orange", icon: "🍊", name: "Orange", type: "normal", weight: 16, payout: [0, 0, 8, 24, 80, 240] },
  { id: "star", icon: "★", name: "Golden Star", type: "normal", weight: 13, payout: [0, 0, 10, 34, 110, 330] },
  { id: "seven", icon: "7", name: "Lucky Seven", type: "normal", weight: 8, payout: [0, 0, 16, 60, 180, 600] },
  { id: "bell", icon: "🔔", name: "Bell", type: "normal", weight: 11, payout: [0, 0, 14, 48, 145, 480] },
  { id: "plum", icon: "🟣", name: "Plum", type: "normal", weight: 15, payout: [0, 0, 9, 28, 90, 280] },
  { id: "wild", icon: "WILD", name: "Wild Crown", type: "wild", weight: 5, payout: [0, 0, 0, 0, 0, 0] },
  { id: "scatter", icon: "$", name: "Scatter Coin", type: "scatter", weight: 6, payout: [0, 0, 2, 10, 40, 100] },
  { id: "bonus", icon: "BONUS", name: "Bonus Diamond", type: "bonus", weight: 4, payout: [0, 0, 0, 0, 0, 0] },
  { id: "goodluck", icon: "LUCK", name: "Good Luck", type: "luck", weight: 4, payout: [0, 0, 0, 3, 12, 35] }
];
